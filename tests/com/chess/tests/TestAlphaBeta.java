 ...
 *
 * The following tests below were already existed within the project but were commented
 * out due to very slow performance and/or were failing from the beginning of taking on this project.
 * To ensure that the entire project's test suites were running efficiently, test cases were retained if
 * they ran in under 3 seconds.
 * */
