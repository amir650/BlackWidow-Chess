...
public class TestAlphaBeta {
    ...
    public void eloTest1() {
        ...
        final MoveStrategy alphaBeta = new AlphaBetaWithMoveOrdering(1500);
        final Move bestMove = alphaBeta.execute(board, 7);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void testQualityDepth6() {
        ...
        final MoveStrategy alphaBeta = new AlphaBetaWithMoveOrdering(1000);
        final Move bestMove = alphaBeta.execute(board, 6);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void eloTest2() {
        ...
        final MoveStrategy alphaBeta = new AlphaBetaWithMoveOrdering(1000);
        final Move bestMove = alphaBeta.execute(board, 8);
        assertEquals(bestMove, Move.MoveFactory
    ...
    public void findMate3() {
        ...
        final MoveStrategy alphaBeta = new StockAlphaBeta();
        final Move bestMove = alphaBeta.execute(board, 5);
        assertEquals(bestMove, Move.MoveFactory
