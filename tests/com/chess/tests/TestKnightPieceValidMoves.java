...
public class TestKnightPieceValidMoves {
    private final String startPosition;
    private final String endPosition;
    private Board board;

    public TestKnightPieceValidMoves (String startPosition, String endPosition) {
    ...
    @Parameterized.Parameters(name="Valid Move: \"{0}\" -> \"{1}\"")
    ...
    public void testPieceMoves() {
        ...
        var startCoordinate = boardUtils.getCoordinateAtPosition(this.startPosition);
        var endCoordinate = boardUtils.getCoordinateAtPosition(this.endPosition);
