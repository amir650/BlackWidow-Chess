 ...
 *
 * The test cases below were all failing during the test run as they require one
 * to have a MySQL database installed on their local machines. For now, they will
 * be skipped over.
 * */
