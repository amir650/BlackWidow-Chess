...
public class TestKnightPiece {
    ...
    // Partition 1 - Test the valid test cases on the board. Rooks can only move straight in all directions.
    @ParameterizedTest()
    @CsvSource({
            "e4,d2",
            "e4,d6",
    ...
    public void testInvalidRookPieceMoves(String startPosition, String endPosition) {
        final Collection<Move> whitePlayerLegalMoves = this.board.whitePlayer().getLegalMoves();
    ...
    public void testInvalidRookPieceMovesOutOfBounds(String startPosition, String endPosition) {
        final Collection<Move> whitePlayerLegalMoves = this.board.whitePlayer().getLegalMoves();
